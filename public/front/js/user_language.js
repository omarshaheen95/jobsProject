...
$(document).on('click', '.btn-edit', (function (e) {
    ...
    $("#id").val(data.id);
    $("#language_id option[value="+data.language_id+"]").attr('selected','selected');
    $("input[name=reading_rate][value="+data.reading_rate+"]").attr("checked", "checked");
    $("input[name=writing_rate][value="+data.writing_rate+"]").attr("checked", "checked");
    $("input[name=conversation_rate][value="+data.conversation_rate+"]").attr("checked", "checked");
    $("#form-content").removeClass("d-none");
}));
