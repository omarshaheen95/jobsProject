                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.department.create') }}"
                    ...
                    <form class="kt-form kt-form--fit kt-margin-b-15" action="" id="search_form" method="get">
                        <div class="row ">
                            ...
                            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile kt-margin-b-15">
                                ...
                                <select name="ministry" class="form-control select2L">
                                    <option value="" selected> اختر جه/ وزارة</option>
                            ...
                            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile kt-margin-b-15">
                                <label>الحالة :</label>
                                <select name="governor" class="form-control">
                                    <option value="" selected>اختر حالة</option>
                                    <option value="1">قسم حاكم</option>
                                    <option value="2">قسم عام</option>
                                </select>
                            </div>
                            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile kt-margin-b-15">
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route("manager.department.destroy", ":id") }}';
      ...
      <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                    ...
                    columns: [
                        {data: 'name', name: 'name'},
                        {data: 'lottery_ministry.name', name: 'lottery_ministry.name'},
