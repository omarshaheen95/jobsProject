...
@section('content')
    @push('breadcrumb')
        <li class="breadcrumb-item">
            سجل الدرجات المستحدثة (الاستثناءات)
        </li>
    @endpush
    <div class="row">
        <div class="col-md-12">
...
@section('script')
    ...
    <script>
      ...
      <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                ...
                ajax: {
                    url: '{{ route('manager.grade.discrimination') }}',
                    data: function (d) {
            ...
            $('#kt_excel').click(function(e){
                e.preventDefault();
                $("#search_form").attr("action",'{{route('manager.grade.discrimination.export')}}');
                $('#search_form').submit();
