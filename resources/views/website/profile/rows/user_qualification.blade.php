<tr id="row_{{$u_q->id}}">
    ...
    <td>
        ...
        <div class="btn-action btn-remove" data-id="{{$u_q->id}}" data-url="{{route('user_qualification.delete', $u_q->id)}}" data-title=" هل تريد حذف المؤهل؟" data-details=" لا يمكنك استرداد هذه المعلومات عند حذفها ؟">
