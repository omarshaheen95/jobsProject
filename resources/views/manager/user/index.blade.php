...
@section('script')
    ...
    <script>
      ...
      <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                    ...
                    columns: [
                        {data: 'name', name: 'name'},
                        {data: 'user_info.uid', name: 'user_info.uid'},
                        {data: 'user_info.gender_name', name: 'user_info.gender_name'},
                        {data: 'user_info.governorate.name', name: 'user_info.governorate.name'},
                        {data: 'user_info.mobile', name: 'user_info.mobile'},
