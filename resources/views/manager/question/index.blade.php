                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.question.create') }}"
                    ...
                    <form class="kt-form kt-form--fit kt-margin-b-15" action="" id="search_form" method="get">
                        <div class="row ">
                            ...
                            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile kt-margin-b-15">
                                ...
                                <select class="form-control select2L" title="اختر نوع" name="question_type"
                                        id="question_type">
                                    <option value="radio">اختيار مفرد
                                    </option>
                                    <option value="checkbox">اختيار متعدد
                                    </option>
                                    <option value="writing">كتابي
                                    </option>
                                    <option value="file">ملف مرفق (PDF)
                                    </option>
                                </select>
                            </div>
                            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile kt-margin-b-15">
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route("manager.question.destroy", ":id") }}';
      ...
      <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                    ...
                    ajax: {
                        url: '{{ route('manager.question.index') }}',
                        data: function (d) {
