                        ...
                        <div class="row ">
                            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile kt-margin-b-15">
                                ...
                                <select class="form-control select2L" name="grade" id="grade">
                                    <option selected value="-100">اختر درجة وظيفية</option>
    ...
    <script>
      ...
      <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                ...
                columns: [
                    ...
                    {data: 'sum_total_required', name: 'sum_total_required'},
            ...
            $('#kt_excel').click(function(e){
                e.preventDefault();
                $("#search_form").attr("action",'{{route('manager.grade.top.export')}}');
                $('#search_form').submit();
